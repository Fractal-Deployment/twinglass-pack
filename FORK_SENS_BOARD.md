...
| Lane | Empty meet (still) | Not this |
|---|---|---|
| Mythos | Composite: capture basin + residual regulation map + Conley-style exit under hierarchy. Elhage QK/OV is the **carrier**, not the closed factor. Find_M / legal Let-fail. | Path-hold identities already exist ≠ Mythos |
...
| N(τ), G1 | Still open | Did not pass four gates this turn. Not forked. |
...
HOLD. Lattice default not rewritten. No ACL. No factor-compute.
