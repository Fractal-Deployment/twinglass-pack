...
You are collecting boards/dumps. Two accounts cannot both be true:
| Lane | Account |
|---|---|
...
Do not invent a dump-meter number. Do not compute from missing dumps — name whether dumps exist.
## Protocol
...
5. Meet only after both pads are finished. Jaccard only at meet. `collate-hourglass`.
## Board (required)
```
