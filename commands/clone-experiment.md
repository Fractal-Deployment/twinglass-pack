...
description: Grok Build CLI experiment. Isolated parallel clones. Methodology, not measurement. Not a GPU. Not grok.com.
---
# Clone experiment (Grok Build CLI)
...
4. Each clone: LRR forward crawl if they leave reason. LCD: in-flight numbers → **ask**; empty meet → **let fail / look elsewhere**. Blind to quality.
5. Meet only after both pads are finished. Collate with `collate-hourglass`. Restate what is true. No refusal.
## Pass
- No sibling read.
