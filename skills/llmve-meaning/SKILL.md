...
- If a text assigns a new job to a meter, stop. Point at the lock file.
- P_L is an emitted meter from orch dumps, not a debate score.
- Methods and apparatus report up. They do not own meaning.
